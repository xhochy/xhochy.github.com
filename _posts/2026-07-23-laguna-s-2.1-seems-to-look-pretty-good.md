...
```shell
pixi shell
VERSION=edd093522473dc7313b0738d8b4116b7f8b9745f
hf download hf://poolside/Laguna-S-2.1-GGUF@${VERSION}/laguna-s-2.1-Q4_K_M.gguf
hf download hf://poolside/Laguna-S-2.1-GGUF@${VERSION}/laguna-s-2.1-DFlash-BF16.gguf
hf download hf://poolside/Laguna-S-2.1-GGUF@${VERSION}/laguna-s-2.1.imatrix
```
...
⚠️  **2026-07-27 
19:15 UTC**: There seems be frequent changes to the models. `edd093522473dc7313b0738d8b4116b7f8b9745f` was the last known working version.
This blog post was written with `e08e1fe855bb2d43f96ad78e24495283f3426c67`. While [tool calling](https://huggingface.co/poolside/Laguna-S-2.1-GGUF/discussions/14) had been an issue, this has been fixed and now a later version of [`Q4_K_M` is simply too large for a 128GB MacBook](https://huggingface.co/poolside/Laguna-S-2.1-GGUF/discussions/18).
